...
def _render_upload_area(analysis_mode: str):
    ...
    with left:
        st.markdown('<div class="panel-heading">Input file</div>', unsafe_allow_html=True)
    ...
    with right:
        st.markdown('<div class="panel-heading">Target role</div>', unsafe_allow_html=True)
...
def render() -> None:
    ...
    st.markdown('<div class="workflow-bar"><span>1. Choose mode</span><span>2. Upload resume</span><span>3. Run analysis</span></div>', unsafe_allow_html=True)
